...
public class ChatbotService {
    ...
    @Value("${ai.buttonAnswerChat}")
    private String aiButtonChatAnswerUrl;
    ...
    public ButtonChatAnswerResponseDTO answer(ButtonChatAnswerRequestDTO buttonChatAnswerRequestDTO) throws JSONException, JsonProcessingException {
        RestTemplate rt = new RestTemplate();
        ...
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("policy_id",buttonChatAnswerRequestDTO.getPolicy_id());
        jsonObject.put("question",buttonChatAnswerRequestDTO.getQuestion());

        HttpEntity<String> stringHttpEntity = new HttpEntity<>(jsonObject.toString(), headers);

        ResponseEntity<String> response = rt.exchange(
                aiButtonChatAnswerUrl,
                HttpMethod.POST,
                stringHttpEntity,
                String.class
        );
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        ButtonChatAnswerResponseDTO buttonChatAnswerResponseDTO = objectMapper.readValue(response.getBody(), ButtonChatAnswerResponseDTO.class);
        return buttonChatAnswerResponseDTO;
    }
}
